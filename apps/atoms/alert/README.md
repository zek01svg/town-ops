...
A backend microservice (Atom) dedicated to managing lifecycle notifications and SLAs. It acts as a data backplane layer constructed using **Hono**, **Bun**, and **Drizzle ORM** with native OpenTelemetry instrumentation.
