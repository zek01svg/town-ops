...
A backend microservice (Atom) dedicated strictly to authentication and user management. It acts as a raw data backplane layer constructed using **Hono**, **Bun**, and **Drizzle ORM** with native OpenTelemetry instrumentation.
