...
A backend microservice (Atom) dedicated to creating, updating, and querying citizen data and property mapping. It acts as a raw data backplane layer constructed using **Hono**, **Bun**, and **Drizzle ORM** with native OpenTelemetry instrumentation.
