...
async def accept_job(
  ...
  try:
    ...
    logger.exception("Step 3 failed (Appointment creation) — initiating full rollback")
  ...
  logger.info("accept_job: success — appointment created", case_id=payload.case_id)
