...
export const assignmentAtomClient = hc<AssignmentAtomType>(env.VITE_ASSIGNMENT_ATOM_URL);
export const appointmentAtomClient = hc<AppointmentAtomType>(env.VITE_APPOINTMENT_ATOM_URL);
export const acceptJobClient = hc<AcceptJobCompositeType>(env.VITE_ACCEPT_JOB_URL);
export const closeCaseClient = hc<CloseCaseCompositeType>(env.VITE_CLOSE_CASE_URL);
export const rescheduleJobClient = hc<RescheduleJobCompositeType>(env.VITE_RESCHEDULE_JOB_URL);
